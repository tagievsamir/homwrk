public class Main {
    public static void main(String[] args) {
        ...
        printColor();
        compareNumbers();
        System.out.println(sumRange(1000,2));
        checkNumber(-23);
        System.out.println(isNegative(-2));
        printStringNTimes("Hello", 4);
        System.out.println(checkYear(4));
    }
    ...
    //Напишите метод, принимающий на вход два целых числа и проверяющий, что их сумма лежит
    ...
    //Напишите метод, которому в качестве параметра передается целое число. Метод должен вернуть true, если
